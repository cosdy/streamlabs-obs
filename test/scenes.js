...
test('The default scene' + index++, async t => {
  const app = t.context.app;
  await focusMain(t);
...
test('Adding and removing a scene' + index++, async t => {
  const app = t.context.app;
...
test('Scene switching with sources' + index++, async t => {
  const app = t.context.app;
  const sceneName = 'Coolest Scene Ever';
...
test('Restarting the app preserves the default sources' + index++, async t => {
...
test('Rename scene' + index++, async t => {
  const app = t.context.app;
...
test('Duplicate scene' + index++, async t => {
  const app = t.context.app;
